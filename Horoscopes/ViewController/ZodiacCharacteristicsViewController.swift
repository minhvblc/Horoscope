...
import UIKit
import SideMenu
class ZodiacCharacteristicsViewController: UIViewController {
    ...
    @IBOutlet weak var datePckerView: UIView!
    @IBOutlet weak var doneDatePickBtn: UIButton!
    ...
    @IBAction func doneDatePickBtn(_ sender: Any) {
        ...
        NotificationCenter.default.post(name: Notification.Name("dateZodiacCharacteristic"), object: nil, userInfo:["info": date])
    ...
    override func viewDidLoad() {
        ...
        super.viewDidLoad()
        screenName.text = "Zodiac Characteristics"
        ...
        if UIDevice.current.userInterfaceIdiom == .pad {
            ...
            self.view.backgroundColor = UIColor(patternImage: UIImage(named: "backgroundPhone2")!)
        }
...
extension ZodiacCharacteristicsViewController: UICollectionViewDelegate, UICollectionViewDataSource{
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        present(vc, animated: true, completion: nil)
        print(indexPath.row)
        NotificationCenter.default.post(name: Notification.Name("zodiacCharacteristic"), object: nil, userInfo:["info": pic[indexPath.row]])
    }
...
extension ZodiacCharacteristicsViewController:UICollectionViewDelegateFlowLayout{
